...
/******  STM32 specific Interrupt Numbers *********************************************************/
  ...
  EXTI4_IRQn                  = 10,     /*!< EXTI Line4 Interrupt                                 */
	                                      // STM32有16个外部中断/事件线，每条中断线上连接PAx - PGx 
																				// 的IO口。但是为什么中断向量表中只有5个外部中断（EXTI0-
																				// EXTI4）？ 
                                        //																				
																				// 它的中断配置是PA0、PB0、PC0......连到EXTI0，PA1、PB1等
																				// 连到EXTI1，以此类推。同一时刻EXTx只能响应同一组内一个
																				// IO口的事件 可以分时复用
																				//
																				//库函数里面除了EXTI0-EXTI4,还有 EXTI15_10_IRQn,
																				//EXTI9_5_IRQn,5到9线是一个中断入口,10到15线有事一个中断入
																				//口
